...
exports.getarticle = handlerFactory.getOne(Article,{path:"doctor",select:"name specialization"},{path:"likers",select:"name photo"});
...
exports.getAllarticle = handlerFactory.getAllpop1(Article,{path:"doctor",select:"name specialization"});
