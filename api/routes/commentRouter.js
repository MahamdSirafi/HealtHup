...
const Comment = require("../models/commentModel");
  ...
  router.route("/").get(addQuery("article",'articleId'),commentController.getAllcomment).post(addVarBody("user","userId"),addVarBody('article','articleId'),commentController.createcomment);
  router
    .route("/:id")
