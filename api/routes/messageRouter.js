const messageController = require("../controllers/messageController");
  ...
  router.use(protect);
  router.route("/").get(restrictTo("user","doctor"),addQuery("chat","chatId"),messageController.getAllmessage)
  .post(restrictTo("user","doctor"),addVarBody("chat","chatId"),messageController.createmessage);
  router
    .route("/:id")
